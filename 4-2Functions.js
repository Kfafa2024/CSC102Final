...
function sound(src)
{//Function is used to make the play buttoon execute the sound
    this.sound = document.createElement("audio") ; //create audio
    //"this" means talk about the current object being made. "this." specifies a value to the current object. //
    this.sound.src = src; // The source is defined 
...
//start a second function for play

function play()
{
    //for each sound create a new function like the one below//
    mySound = new sound("Sounds/swan-lake.mp3");
    mySound.play();
}

// How to make the sound stop //
function stop()
{
